 ...
 */
@WebServlet(urlPatterns = { "/trigger2" }) /// "PageControl" for ritwik's page Page
...
//			request.setAttribute("stockList", stockList);
			...
			//request.getRequestDispatcher("blocksCreated.jsp").forward(request, response);
			response.sendRedirect("blocksCreated.jsp");
