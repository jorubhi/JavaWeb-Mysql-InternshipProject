...
<%@page
	import="java.sql.Connection, java.sql.Date, java.sql.PreparedStatement,java.sql.ResultSet, java.sql.SQLException, java.util.ArrayList,java.util.List, com.sapient.pm.db.MySQLConnectorFactory, com.sapient.pm.model.Trader,com.sapient.pm.model.Stock,com.sapient.pm.repository.JdbcRepository,java.util.Set,java.util.HashMap  "%>
<html>
<head>
<meta charset="utf-8" />
					...
					<table class="table table-bordered table-hover">
						...
						<tbody>
							<%
								...
								HashMap<String, Integer> portfolio = repository.getPortfolio();
							%>
							<%
								Set<String> key = portfolio.keySet();
								for (String s : key) {
									if (portfolio.get(s) > 0) {
							%>

							<tr>
								<td><%=s%></td>
								<td><%=repository.getMarketData(s)%></td>
								<td><%=portfolio.get(s)%></td>
							...
							<div class="form-group">
								<div class="col-3">
									Trader: <select class="form-control" style="width: 200px"
										...
										<option name="trader" value="1">John</option>
										<option name="trader" value="2">Anny</option>
										<option name="trader" value="3">Arsh</option>
									</select>
								</div>
							</div>
							<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-75">
								<select id="trader" class="btn btn-default dropdown-toggle"
									...
									<option value="3">Arsh Awasthi</option>
								</select>
							</div>
						</div>
						<div class="row">
							<button class="btn btn-danger" id="btn12">Submit</button>
						</div>
					</form>
